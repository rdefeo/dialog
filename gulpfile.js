...
(function () {
    ...
    var srcFolder = 'web_source';
    var distFolder = 'static';
    ...
    gulp.task('bower:copy', function () {
        return gulp.src(['.tmp/bower_components/**/*']).pipe(gulp.dest(distFolder+'/bower_components'));
    });
...
//    gulp.watch(['app/fonts/**/*'], ['fonts']);
    ...
    gulp.task('dist', ['clean'], function (cb) {
        runSequence('styles', ['html', 'fonts', 'images', 'bower:copy'], cb);
    });
